    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
		...
		<li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="cadastroUsuario.html">Cadastre-se</a>
          </li>
          <li class="nav-item">
	 ...
	 <div class="container fluid">
		 <div class="row">
			...
			Nome:
			<input type="text" name="nomeCli" placeholder="Digite seu nome" size="55" maxlength="50" />
				
			CPF:
			<input type="text" name="cpfCli" placeholder="Digite seu CPF" maxlength="11" />
			...
			Data de nascimento:
			<input type="text" name="dtaNasc" maxlength="10" placeholder="dd/mm/aaaa" size="35"  />

			<hr/>
			Telefone:
			<input type="text" name="telefoneCli" maxlength="13" placeholder="(xx)xxxxx-xxxx" />
			...
			N°:
			<input type="text" name="endNumCli" maxlength="5" placeholder="N° da casa" />
			<hr/>

			CEP:
			<input type="text" name="cepCli" maxlength="8" placeholder="Cep" />
			
			Cidade:
			<input type="text" name="cidadeCli" maxlength="40" placeholder="Cidade " />

			Bairro:
			<input type="text" name="bairroCli" maxlength="30" placeholder="Bairro " />
			<hr/>

			Email: 
			<input type="text" name="emailCli" placeholder="Digite seu email" maxlength="40" />
			...
			Senha:
			<input type="password" name="senha" maxlength="20" placeholder="Digite sua senha" />

			<hr/>
			Confirme sua senha:
			<input type="password" name="confSenha" maxlength="20" placeholder="Repita sua senha" />
